    ...
    <tbody>
        <tr style="padding:0;text-align:center;vertical-align:top;width:100%;" align="center">
            <td>                 
                ...
                <div>
                    <span style="padding:0 25px;color:#4a5773;font:400 16px Arial;margin-bottom:30px;"><?= Yii::t('main', 'We received a request to change the password for your personal account on the site {site}', ['site' => Yii::$app->name]) ?></span>
                    <a href="<?= $remindLink ?>" style="display:block;width:250px;height:40px;text-align:center;background-color:#1c69ff;color:#ffffff;font:400 16px Arial;text-transform:uppercase;text-decoration:none;line-height:40px;margin:30px auto;"><?= Yii::t('main', 'Confirm') ?></a>
                </div>
